...
(\citealt{Herdegen2017}, Proposition~3.5). Our Bond-Family formulation (BF) is
...
across the uncountable index set to exist (cf.~\citealt{BalbasIbanezLopez2002} for the general framework; \citealt{Filipovic2001,Filipovic2009} for related consistency
...
theorem). \citet{GatheralJaissonRosenbaum2018} established that
...
projective limit framework of \citealt{BalbasIbanezLopez2002}, the consistency
analysis of \citet{Filipovic2001}, and the large-market FTAP literature
\citep{CuchieroKleinTeichmann2016,DeDonno2004,TakokaSchweizer2014} may provide relevant tools. In particular, the
...
classes that permit maturity-dependent \(\lambda\) (\citealt{Duffee2002,JoslinSingletonZhu2011}) --- or within non-Gaussian specifications
...
\(\text{NA}^{\text{ni}}\) in continuous time.} \citeauthor{Herdegen2017}'s
numéraire-independent FTAP, the NAFL condition of
\citeauthor{KleinSchmidtTeichmann2016}, and our Bond-Family condition share the feature
